<template>
  <div>
    <!-- 添加成功提示 -->
    <div style="margin-top: 15px;" class="add-info-box-container">
      <div class="add-info-box">
        <div class="add-info-detail">
          ...
          <div class="add-info-box-row">
            <div class="add-info-img">
              <img :src="newShoppingCart.goodsInfo.imgUrl" alt="">
            </div>
            <div class="add-info-intro">
              <p>{{newShoppingCart.goodsInfo.title}} {{newShoppingCart.goodsInfo.subTitle}}...</p>
              <p class="add-info-intro-detail">规格：{{newShoppingCart.spec}}/ 数量：{{newShoppingCart.buyCont}}</p>
            </div>
          </div>
        </div>
        <div class="car-btn-group">
          ...
          <div class="car-btn-row">
            <router-link :to="'/goodsDetail?goodsId='+newShoppingCart.goodsId">
    ...
    <div class="other-user-buy-box">
      ...
      <div class="other-user-buy-row" >
        <div class="other-user-buy-item-box" v-for="(item,index1) in recommend.goodses" :key="index1">
          <div class="other-user-buy-item-img">
            <a href="item_detail.html"><img :src="item.imgUrl" alt=""></a>
          </div>
          <div class="other-buy-detail-box">
            ...
            <div class="other-buy-btn-box">
              <router-link :to="'/goodsDetail?goodsId='+item.id">
                <button class="other-buy-btn"><Icon type="ios-cart"></Icon> 查看</button>
              </router-link>
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted () {
    this.loadRecommend({goodsId:this.newShoppingCart.goodsId});
  },
  computed: {
