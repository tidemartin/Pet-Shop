...
module.exports = {
    ...
    buildDelete:function(entity){
        let sql=`delete from brand `
        let q=this.buildWhere(entity)
        q.sql=sql+q.sql
        return q
    },
    buildCont:function(entity){
        let sql = `select count(*) from brand `
        let q=this.buildWhere(entity)
        q.sql=sql+q.sql
        return q
    },
    ...
    queryById:function (entity,callback,conn) {
        let sqlStr="select * from brand where id = ?"
        let sql={
            sql:sqlStr,
            params:[entity.id]
        }
    ...
    deleteById:function (entity,callback,conn) {
        let sqlStr="delete from brand where id = ?"
        let sql={
            sql:sqlStr,
            params:[entity.id]
        }
