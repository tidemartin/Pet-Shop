...
var repo = require("../repo/liveMsg-repo")
var audit=require('../utils/audit-utils')

/* liveMsg page. */
router.all('/liveMsg/page', function(req, res, next) {
...
router.all('/liveMsg/all', function(req, res, next) {
    repo.queryAll(req.body,r=>{
        res.json(r)
    })
})

router.all('/liveMsg/one', function(req, res, next) {
    repo.queryById(req.body,r=>{
        res.json(r)
    })
})

router.all('/liveMsg/save', function(req, res, next) {
...
router.all('/liveMsg/delete', function(req, res, next) {
