...
<!--                <el-button type="mini" @click="reply(item)" >回复</el-button>-->
              </div>
            </div>
          </div>
        </template>
      ...
      <el-table-column label="留言用户" prop="username">
      </el-table-column>
      <el-table-column label="留言内容" prop="msg">
      </el-table-column>
      <el-table-column label="留言时间" prop="createDate">
    ...
    <el-dialog title="回复留言" :visible.sync="eformV" >
...
export default {
  ...
  methods:{
    ...
    add(){
      ...
      edit(id){
        this.$http.post("/api/livemsg/one",{id:id}).then(r=>{
          this.eform=r.body.data
          this.eformV=true
        })
      },
      del(id){
        this.$http.post("/api/livemsg/delete",{id:id}).then(r=>{
      ...
      save(){
        ...
        this.$http.post("/api/livemsg/save",this.eform).then(r=>{
    ...
    load(p){
      ...
      this.$http.post("/api/livemsg/page",param).then(r=>{
